...
import { AGENT_DIRECTORIES } from "./frontmatter.mjs";
...
const README_COUNT_ANCHORS = Object.freeze({
  "README.md": [
    ...
    {
      label: "closing total",
      // Tool support grows independently from the agent catalog. Validate the
      // agent total while accepting any positive documented tool count.
      pattern: /\*\*(\d+)\s*个 AI 专家角色，[1-9]\d*\s*种工具支持，即装即用\*\*/g,
    },
  ],
  "README.zh-TW.md": [
    {
